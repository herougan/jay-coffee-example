...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    desc: 'Venture into the unknown with an unheard of combination- ghost pepper and coconut. Our fluffy coconut sponge cake is dusted with in-house milled ghost pepper powder.',
  ...
  },
  {
    ...
    desc: 'Red velvet goodness. Makes you feel like the roses are falling on you',
    tags: ['Red Velvet'],
    price: 45,
    colour: 'yellow',
    notes: 'Cherry, Chocolate, Almond',
  },
  {
    ...
    desc: "The basic chocolate lava cake, but we're keeping it classy.",
